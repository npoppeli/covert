...
Attributes:
    ...
    * patterns:       abbreviations for regular expressions in routes
...
Functions:
    ...
    * split_route:    split route into components
...
from .view       import patterns, split_route, route2pattern, route2regex
